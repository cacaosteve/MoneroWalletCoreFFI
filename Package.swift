...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/cacaosteve/MoneroWalletCoreFFI/releases/download/walletcore-v0.1.1/MoneroWalletCore.xcframework.zip",
            checksum: "28c96ef6a43d61eb56ecb5d4be0a82314622406b9ca0f9edc5f738ba5df9817f"
        ),
        clibTarget,
        .target(
            name: "MoneroWalletCoreFFI",
